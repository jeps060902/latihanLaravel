<nav class="bg-gray-800" x-data="{ isMobileMenuOpen: false, isProfileMenuOpen: false }">
            ...
            <div class="md:block xs:hidden">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        ...
                        <div x-show="isProfileMenuOpen" x-transition:enter="transition ease-out duration-100 transform"
